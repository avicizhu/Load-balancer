...
//  LogComponentEnable ("DropTailQueue", LOG_LEVEL_LOGIC);
  ...
  nodes.Create (2);
      ...
      CsmaHelper csma;
//      csma.SetQueue ("ns3::DropTailQueue","MaxPackets",UintegerValue(4));
...
//  pointToPoint.SetQueue ("ns3::DropTailQueue","MaxPackets",UintegerValue(3));
...
*/
  ...
  clientApps = echoClient1.Install (nodes.Get (0));
  clientApps.Start (Seconds (2.0));
  clientApps.Stop (Seconds (10.0));
