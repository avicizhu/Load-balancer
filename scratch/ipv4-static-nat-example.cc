...
//                              192.168.1.5  203.82.48.1   203.82.48.2
 ...
 // address3.SetBase ("203.82.49.0", "255.255.255.0");
 ...
 //Ipv4InterfaceContainer thirdInterfaces = address3.Assign (devices3);
  ...
  Ipv4StaticNatRule rule2 (Ipv4Address ("192.168.1.1"), 80, Ipv4Address ("203.82.48.1"), 8080, IPPROTO_UDP);
  nat->AddStaticRule (rule2);
  Ipv4StaticNatRule rule3 (Ipv4Address ("192.168.1.2"), 80, Ipv4Address ("203.82.48.1"), 8080, IPPROTO_UDP);
  nat->AddStaticRule (rule3);
  Ipv4StaticNatRule rule4 (Ipv4Address ("192.168.1.3"), 80, Ipv4Address ("203.82.48.1"), 8080, IPPROTO_UDP);
  nat->AddStaticRule (rule4);
  Ipv4StaticNatRule rule5 (Ipv4Address ("192.168.1.4"), 80, Ipv4Address ("203.82.48.1"), 8080, IPPROTO_UDP);
  ...
  UdpEchoClientHelper echoClient (secondInterfaces.GetAddress (0), 8080);
  //UdpEchoClientHelper echoClient (Ipv4Address("203.82.48.1"), 8080);
  echoClient.SetAttribute ("MaxPackets", UintegerValue (3));
  echoClient.SetAttribute ("Interval", TimeValue (Seconds (1.0)));
  echoClient.SetAttribute ("PacketSize", UintegerValue (512));

  ApplicationContainer clientApps = echoClient.Install (second.Get (1));
  clientApps.Start (Seconds (2.0));
  clientApps.Stop (Seconds (10.0));
 /* 
  UdpEchoClientHelper echoClient1 (thirdInterfaces.GetAddress (0), 8080);
  echoClient1.SetAttribute ("MaxPackets", UintegerValue (1));
  echoClient1.SetAttribute ("Interval", TimeValue (Seconds (1.0)));
  echoClient1.SetAttribute ("PacketSize", UintegerValue (512));
  clientApps = echoClient1.Install (third.Get (1));
  clientApps.Start (Seconds (3.0));
  clientApps.Stop (Seconds (10.0));
  
  UdpEchoClientHelper echoClient1 (Ipv4Address("203.82.48.1"), 8081);
  echoClient1.SetAttribute ("MaxPackets", UintegerValue (1));
  echoClient1.SetAttribute ("Interval", TimeValue (Seconds (1.0)));
  echoClient1.SetAttribute ("PacketSize", UintegerValue (512));
  clientApps = echoClient1.Install (second.Get (1));
  clientApps.Start (Seconds (2.0));
  clientApps.Stop (Seconds (10.0));
  */
